...
class KPlotter:
    ...
    def plot_can_current(self,msg,fignum):  
        self.plot_setup(fignum)
    ...
    def plot_can_duty_cycle(self,msg,fignum):  
        self.plot_setup(fignum)
    ...
    def plot_can_duty_cycle_vesc(self,msg,fignum):  
        self.plot_setup(fignum)
    ...
    def plot_can_tacho(self,msg,fignum):  
        self.plot_setup(fignum)
    ...
    def plot_can_downdrops(self,msg,fignum):
        self.plot_setup(fignum)
    ...
    def plot_can_angle(self,msg,fignum):
        self.plot_setup(fignum)
...
#    def plot_desired_speed(self,msg):    
#        self.plot_setup(4)
