...
class KPlotter:
    ...
    def plot_can_ctrl_erpm(self,msg):
        self.plot_setup()
        plot.plot(msg.values_0x31.time, msg.values_0x31.erpm,'r.-', linewidth=0.5, label='desired_motor_F-R(31h)_erpm[-]')
        plot.plot(msg.values_0x32.time, msg.values_0x32.erpm,'g.-', linewidth=0.5, label='desired_motor_F-L(32h)_erpm[-]')
        plot.plot(msg.values_0x33.time, msg.values_0x33.erpm,'y.-', linewidth=0.5, label='desired_motor_M-R(33h)_erpm[-]')
        plot.plot(msg.values_0x34.time, msg.values_0x34.erpm,'k.-', linewidth=0.5, label='desired_motor_M-L(34h)_erpm[-]')
        plot.plot(msg.values_0x35.time, msg.values_0x35.erpm,'y.-', linewidth=0.5, label='desired_motor_R-R(35h)_erpm[-]')
        plot.plot(msg.values_0x36.time, msg.values_0x36.erpm,'k.-', linewidth=0.5, label='desired_motor_R-L(36h)_erpm[-]')
        plot.title('CAN: desired_erpm', size=12, loc='left')
